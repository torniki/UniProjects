//---------------------------------------------------------------------------
// Модуль вычисления значений символьных выражений, версия 2.1 (win32)
...
extern unsigned __stdcall StrToPolStr (const char *, char *, unsigned);
//---------------------------------------------------------------------------
...
extern char * __stdcall CreatePolStr(const char *, unsigned);
//---------------------------------------------------------------------------
...
extern double __stdcall EvalStr(const char *, double, unsigned = 0);
//---------------------------------------------------------------------------
...
// EvalStr.
extern double __stdcall EvalStr(const char *, const double *, unsigned,
...
extern double __stdcall EvalPolStr(const char *, double, unsigned = 0);
//---------------------------------------------------------------------------
...
// вторую производные.
extern double __stdcall EvalPolStr(const char *, const double *, unsigned = 0,
	unsigned = 0);
//---------------------------------------------------------------------------
#endif
//---------------------------------------------------------------------------
